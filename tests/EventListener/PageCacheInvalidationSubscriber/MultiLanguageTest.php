...
class MultiLanguageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function pathInvalidatonOnPageUnpublishing()
    {
        $this->cacheManager
            ...
            ->with($this->equalTo('de/path/to/page'))
        ...
        $this->urlGenerator
            ->expects($this->once())
            ->method('generate')
            ->with($this->equalTo('_slug'), $this->equalTo(['url' => 'path/to/page', '_locale' => 'de']))
            ->willReturn('de/path/to/page');
    ...
    public function pathInvalidationOnPageDeletion()
    {
        $this->cacheManager
            ->expects($this->once())
            ->method('invalidatePath')
            ->with($this->equalTo('de/path/to/another/page'))
            ->willReturn($this->cacheManager);
        $this->domainConfiguration
            ->expects($this->once())
            ->method('isMultiLanguage')
        ...
        $this->urlGenerator
            ->expects($this->once())
            ->method('generate')
            ->with($this->equalTo('_slug'), $this->equalTo(['url' => 'path/to/another/page', '_locale' => 'de']))
            ->willReturn('de/path/to/another/page');
    ...
    public function pathInvalidationOnPageUpdate()
    {
        $this->cacheManager
            ->expects($this->once())
            ->method('invalidatePath')
            ->with($this->equalTo('de/path/to/page/three'))
            ->willReturn($this->cacheManager);
        $this->domainConfiguration
            ->expects($this->once())
            ->method('isMultiLanguage')
        ...
        $this->urlGenerator
            ->expects($this->once())
            ->method('generate')
            ->with($this->equalTo('_slug'), $this->equalTo(['url' => 'path/to/page/three', '_locale' => 'de']))
            ->willReturn('de/path/to/page/three');
